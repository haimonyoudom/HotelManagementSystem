...
public class BookingHistoryPanel {
    ...
    private static Color[] getBadgeColors(String status) {
        switch (status) {
            case "Checked In":
                return new Color[] { BADGE_IN_BG, BADGE_IN_FG };
            case "Pending":
                return new Color[] { BADGE_PENDING_BG, BADGE_PENDING_FG };
            case "Approved":
                return new Color[] { BADGE_APPR_BG, BADGE_APPR_FG };
            case "Checked Out":
                return new Color[] { BADGE_OUT_BG, BADGE_OUT_FG };
            case "Cancelled":
                return new Color[] { BADGE_CANC_BG, BADGE_CANC_FG };
            default:
                return new Color[] { BADGE_OUT_BG, BADGE_OUT_FG };
        }
    }
