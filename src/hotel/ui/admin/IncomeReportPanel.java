...
public class IncomeReportPanel extends JPanel {
    ...
    public IncomeReportPanel() {
        ...
        top.add(reportCard("Total Revenue", totalRevenueLabel, UITheme.SUCCESS));
        top.add(reportCard("Paid Payments", paidCountLabel, UITheme.PRIMARY));
        top.add(reportCard("Pending", pendingCountLabel, UITheme.SECONDARY));
        top.add(reportCard("Failed", failedCountLabel, UITheme.DANGER));
    ...
    public void reload() {
        try {
            ...
            for (Payment payment : payments) {
                String status = payment.getStatus() == null ? "" : payment.getStatus().trim();
